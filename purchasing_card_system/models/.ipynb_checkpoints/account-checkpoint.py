...
class ProductTemplate(models.Model):
    ...
    card_purchase_inverse_id = fields.Many2one('card.purchase')
    card_purchase_payment_id = fields.Many2one('card.purchase')
    ...
    def _onchange_partner_id(self):
        ...
        warning = {}
        if self.partner_id:
            rec_account = self.partner_id.property_account_receivable_id if not(self.partner_account_id) else self.partner_account_id
        ...
        if self.is_sale_document(include_receipts=True) and self.partner_id:
            ...
            new_term_account = self.partner_id.commercial_partner_id.property_account_receivable_id if not(self.partner_account_id) else self.partner_account_id
        ...
        def _get_payment_terms_account(self, payment_terms_lines):
            ...
            if payment_terms_lines:
                ...
                if self.is_sale_document(include_receipts=True):
                    return self.partner_id.property_account_receivable_id if not(self.partner_account_id) else self.partner_account_id
                else:
